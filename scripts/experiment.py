...
def main(parser: ArgumentParser = None, **kwargs):
    ...
    parser.add_argument("-model", type=str, default="NightconstrainedModel", help="Hybrid Model")
    ...
    parser.add_argument("-nIter", type=int, default=30000, help="training steps")
    ...
    data_config = {'hybrid_model':model_config['hybrid_model'],
                    'nn_1': ['VPD', 'doy_cos', 'doy_sin', 'PA', 'P', 'WS', 'SW_IN_POT', 'TA'] + args.SW*['SW_IN'], #'PA', 'RH', 'WS', 'P', 'tod_sin', 'tod_cos' #'SW_IN_POT', 'TA', 'WS', 'SWC_1', 
                    'nn_2': ['VPD', 'doy_cos', 'doy_sin', 'PA', 'P', 'WS', 'SWC_1', 'TS_1'] + args.TA*['TA'], #'PA', 'RH', 'WS', 'P', 'tod_sin', 'tod_cos' #'SWC_1', 'TS_1',
                    'split': 'random',
                    'site': args.site,
                    'year': args.year,
                    'filter': 'Tramontana',
