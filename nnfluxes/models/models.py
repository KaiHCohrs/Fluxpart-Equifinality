...
class BaseModel:
    ...
    def net_forward(self, params1, params2, inputs1, inputs2, inputs3, inputs4, p, rng_key):
        ...
        GPP = jax.nn.softplus(self.apply1(params1, inputs1, 0, rng_key1))
...
class PriorBaseModel:
    ...
    def net_forward(self, params1, params2, inputs1, inputs2, inputs3, inputs4, p, rng_key):
        ...
        GPP = (self.apply1(params1, inputs1, p, rng_key1)) + inputs3)
        RECO = (self.apply2(params2, inputs2, p, rng_key2) + inputs4)
    ...
    def net_forward_test(self, params1, params2, inputs1, inputs2, inputs3, inputs4):
        ...
        GPP = (self.apply_eval1(params1, inputs1) + inputs3)
        RECO = (self.apply_eval2(params2, inputs2) + inputs4)
